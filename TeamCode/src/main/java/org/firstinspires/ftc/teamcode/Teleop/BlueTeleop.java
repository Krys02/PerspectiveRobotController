...
public class BlueTeleop extends OpMode {
    ...
    public ShotPosition position = ShotPosition.BLUE_STRAIGHT;
    PerspectiveHardware h = new PerspectiveHardware();
    ElapsedTime timer = new ElapsedTime();
    /**
     * BLUE wall shots | high goal is (0.88, 0.49), velocity is 1500 tps | power shots are (0.82, 0.36), velocity is 1520 tps
     * BLUE straight shots | high goal is (0.87, 0.48), velocity is 1520 tps | power shots are (0.82, 0.38), velocity is 1520 tps
     * BLUE cross shots | high goal is (0.86, 0.46), velocity is 1500 tps | power shots are (0.82, 0.4), velocity is 1500 tps
     * BLUE center shots | high goal is (0.86, 0.46), velocity is  1500 tps| power shots (0.82, 0.38), velocity is 1500 tps
     */
    ...
    public void getShotPosition() {
        if (gamepad1.dpad_left)
            position = ShotPosition.BLUE_WALL;
        if (gamepad1.dpad_up)
            position = ShotPosition.BLUE_STRAIGHT;
        if (gamepad1.dpad_right)
            position = ShotPosition.BLUE_CROSS;
        if (gamepad1.dpad_up)
            position = ShotPosition.BLUE_CENTER;
    }
