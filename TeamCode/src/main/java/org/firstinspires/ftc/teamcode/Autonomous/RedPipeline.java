...
import org.firstinspires.ftc.teamcode.Autonomous.Randomization;
...
public class RedPipeline extends OpenCvPipeline {
    ...
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(210, 120 - (75 / 2));
    ...
    final int FOUR_RING_THRESHOLD = 70;
    final int ONE_RING_THRESHOLD = 30;
